...
ActiveRecord::Schema[7.1].define(version: 2024_04_25_103046) do
  ...
  create_table "screens", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "seats", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "number"
  ...
  create_table "showings", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
